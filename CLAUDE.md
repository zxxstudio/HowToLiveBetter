...
10. 恋爱和结婚划不划算（择偶策略与「广撒网 vs 死追」、纠缠的治安红线、兴趣信号、关系质量、异地恋、登记流程、婚检、登记数据口径、健康账、时间账、钱账、退出成本、为长辈结婚、吵架时的敌意与健康账（婚姻质量荟萃 + 伤口愈合实验，B）；长文放 docs/结婚划不划算.md）
